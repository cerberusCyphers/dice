...
var score1El = document.getElementById('score--1'); // another way to link the html element.  May be faster.
...
var switchPlayer = function switchPlayer() {
  ...
  currentScore = 0;
  current0El.textContent = currentScore; // player0El.classList.remove('player--active');
...
btnHold.addEventListener('click', function () {
  if (playing) {
    ...
    if (scores[activePlayer] >= 100) {
      ...
      document.querySelector(".player--".concat(activePlayer)).classList.add('active--player');
      diceEl.classList.add('hidden');
    } else {
      switchPlayer();
    }
